    ...
    <div>
      ...
      >
        <ModalContent sx={{ width: 400 }}>
          <h2 id="unstyled-modal-title" className="modal-title text-center text-[32px] p-2 fs-2 text-gray-500 ">
            Verification Email :)
          </h2>
          <form onSubmit={handleSubmit} className='flex flex-col gap-5'>
            ...
            <button type='submit'  className='p-3 text-[18px] bg-gray-500 text-white border-none rounded'>Submit</button>
          </form>
        </ModalContent>
      </Modal>
    </div>
